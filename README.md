...
This tool is just a few very simple batch files that use [youtube-dl](https://youtube-dl.org/) (currently the [yt-dlp](https://github.com/yt-dlp/yt-dlp) fork). The reason why you might want to use this instead of using youtube-dl directly is because youtube-dl by default...
